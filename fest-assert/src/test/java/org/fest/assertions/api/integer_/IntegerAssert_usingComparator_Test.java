...
/**
 * Tests for <code>{@link IntegerAssert#usingComparator(Comparator)}</code>.
 * 
 * @author Joel Costigliola
 */
public class IntegerAssert_usingComparator_Test extends IntegerAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    ...
    assertSame(getIntegers(assertions).getComparator(), comparator);
  }
}
