...
/**
 * Tests for <code>{@link ObjectArrayAssert#areNot(Condition)}</code>.
 * 
 * @author Nicolas François
 * @author Mikhail Mazursky
 */
public class ObjectArrayAssert_areNot_Test extends ObjectArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertAreNot(getInfo(assertions), getActual(assertions), condition);
  }
}
