...
/**
 * Tests for <code>{@link ObjectArrayAssert#have(Condition)}</code>.
 * 
 * @author Nicolas François
 * @author Mikhail Mazursky
 */
public class ObjectArrayAssert_doNothave_Test extends ObjectArrayAssertBaseTest {
  ...
  protected void verify_internal_effects() {
    verify(arrays).assertHave(getInfo(assertions), getActual(assertions), condition);
  }
}
