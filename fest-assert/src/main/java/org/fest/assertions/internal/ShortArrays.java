...
public class ShortArrays {
   ...
   * <code>{@link #assertContainsSequence(AssertionInfo, short[], short[])}</code>, but it also verifies that the first element in
   ...
   * <code>{@link #assertContainsSequence(AssertionInfo, short[], short[])}</code>, but it also verifies that the last element in
