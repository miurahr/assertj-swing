...
/**
 * Tests for {@link JTableDriver#unselectCells(javax.swing.JTable, org.assertj.swing.data.TableCell[])}.
 *
 * @author Christian Rösch
 */
public class JTableDriver_unselectCells_Test extends JTableDriver_TestCase {
  @Test
  public void should_Unselect_Cells() {
    ...
    driver.unselectCells(table, array(row(0).column(0), row(2).column(0)));
  ...
  public void should_Unselect_Cell() {
    ...
    requireCellSelected(0, 0);
    requireCellSelected(2, 0);
    driver.unselectCells(table, array(row(0).column(0)));
    requireCellNotSelected(0, 0);
    requireCellSelected(2, 0);
  }
