...
public class JListDriver_unselectItemByIndex_withInvalidIndex_Test extends JListDriver_TestCase {
  ...
  public JListDriver_unselectItemByIndex_withInvalidIndex_Test(int index) {
    this.index = index;
  }
