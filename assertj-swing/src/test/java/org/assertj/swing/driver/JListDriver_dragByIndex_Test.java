 ...
 * @author Yvonne Wang
 */
public class JListDriver_dragByIndex_Test extends JListDriver_TestCase {
  @Test
  public void should_Throw_Error_If_JList_Is_Disabled() {
    disableList();
    assertThatIllegalStateExceptionCauseIsDisabledComponent(() -> driver.drag(list, 0));
  }

  @Test
  public void should_Throw_Error_If_JList_Is_Not_Showing_On_The_Screen() {
    assertThatIllegalStateExceptionCauseIsNotShowingComponent(() -> driver.drag(list, 0));
  }
}
