...
public class JTreeDriver_expandPath_Test extends JTreeDriver_toggleCell_TestCase {
  ...
  public void should_Throw_Error_If_Path_Does_Not_Exist() {
    showWindow();
    Throwable t = Assert.assertThrows(LocationUnavailableException.class, () -> driver.expandPath(tree, "somePath"));
  ...
  public void should_Throw_Error_If_JTree_Is_Disabled() {
    disableTree();
    assertThatIllegalStateExceptionCauseIsDisabledComponent(() -> driver.expandPath(tree, "root"));
  }

  @Test
  public void should_Throw_Error_If_JTree_Is_Not_Showing_On_The_Screen() {
    assertThatIllegalStateExceptionCauseIsNotShowingComponent(() -> driver.expandPath(tree, "root"));
  }
}
