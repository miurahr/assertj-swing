...
public class JTableDriver_columnIndex_withInvalidInput_Test extends JTableDriver_TestCase {
  ...
  public void should_Throw_Error_If_Column_With_Given_Id_Was_Not_Found() {
    Throwable t = Assert.assertThrows(ActionFailedException.class, () -> driver.columnIndex(table, "Hello World"));
    Assert.assertTrue(t.getMessage().contains("Unable to find a column with id 'Hello World"));
  }
}
