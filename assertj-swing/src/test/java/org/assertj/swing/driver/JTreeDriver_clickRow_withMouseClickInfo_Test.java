...
public class JTreeDriver_clickRow_withMouseClickInfo_Test extends JTreeDriver_clickCell_TestCase {
  ...
  private static final MouseClickInfo mouseClickInfo = rightButton().times(2);
  ...
  public void should_Throw_Error_If_Row_Is_Out_Of_Bounds() {
    showWindow();
    Throwable t = Assert.assertThrows(IndexOutOfBoundsException.class, () -> driver.clickRow(tree, 100, mouseClickInfo));
    Assert.assertTrue(t.getMessage().contains("The given row <100> should be between <0> and <6>"));
  }

  @Test
  public void should_Throw_Error_If_JTree_Is_Disabled() {
    disableTree();
    assertThatIllegalStateExceptionCauseIsDisabledComponent(() -> driver.clickRow(tree, 1, mouseClickInfo));
  }

  @Test
  public void should_Throw_Error_If_JTree_Is_Not_Showing_On_The_Screen() {
    assertThatIllegalStateExceptionCauseIsNotShowingComponent(() -> driver.clickRow(tree, 1, mouseClickInfo));
  }
}
