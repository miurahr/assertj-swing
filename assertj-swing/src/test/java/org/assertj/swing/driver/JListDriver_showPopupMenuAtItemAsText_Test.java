...
public class JListDriver_showPopupMenuAtItemAsText_Test extends JListDriver_showPopupMenu_TestCase {
  ...
  public void should_Throw_Error_If_JList_Is_Disabled() {
    disableList();
    assertThatIllegalStateExceptionCauseIsDisabledComponent(() -> driver.showPopupMenu(list, "o.*"));
  }

  @Test
  public void should_Throw_Error_If_JList_Is_Not_Showing_On_The_Screen() {
    assertThatIllegalStateExceptionCauseIsNotShowingComponent(() -> driver.showPopupMenu(list, "o.*"));
  }
}
