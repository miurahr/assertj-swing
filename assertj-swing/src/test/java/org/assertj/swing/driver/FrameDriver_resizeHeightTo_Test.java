...
public class FrameDriver_resizeHeightTo_Test extends FrameDriver_TestCase {
  ...
  public void should_Throw_Error_If_Frame_Is_Disabled() {
    disableWindow();
    assertThatIllegalStateExceptionCauseIsDisabledComponent(() -> driver.resizeHeightTo(window, 10));
  }

  @Test
  public void should_Throw_Error_If_Frame_Is_Not_Showing_On_The_Screen() {
    assertThatIllegalStateExceptionCauseIsNotShowingComponent(() -> driver.resizeHeightTo(window, 10));
  }

  @Test
  public void should_Throw_Error_If_Frame_Is_Not_Resizable() {
    makeWindowNotResizable();
    assertThatIllegalStateExceptionCauseIsNotResizableComponent(() -> driver.resizeHeightTo(window, 10));
  }
}
