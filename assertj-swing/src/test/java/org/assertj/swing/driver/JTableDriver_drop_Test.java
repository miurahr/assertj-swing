...
/**
 * Tests for {@link JTableDriver#drop(javax.swing.JTable, org.assertj.swing.data.TableCell)}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JTableDriver_drop_Test extends JTableDriver_TestCase {
  ...
  public void should_Throw_Error_If_JTable_Is_Not_Showing_On_The_Screen() {
    Assert.assertThrows(IllegalStateException.class, () -> driver.drop(table, row(0).column(0)));
  }
}
