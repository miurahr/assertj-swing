...
public class AbstractButtonDriver_requireSelected_Test extends AbstractButtonDriver_TestCase {
  ...
  public void should_Fail_If_Button_Is_Not_Selected() {
    ...
    Throwable t = Assert.assertThrows(AssertionError.class, () -> driver.requireSelected(checkBox));
    assertThat(t.getMessage()).contains("property:'selected'").contains("expected:<[tru]e> but was:<[fals]e>");
  }
}
