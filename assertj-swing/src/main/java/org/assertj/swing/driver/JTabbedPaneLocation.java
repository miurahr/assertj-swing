...
public class JTabbedPaneLocation {
   ...
   */
  @RunsInCurrentThread
  public int indexOf(@NotNull JTabbedPane tabbedPane, @Nullable String title) {
   ...
   */
  @RunsInCurrentThread
  public int indexOf(final @NotNull JTabbedPane tabbedPane, final @NotNull TextMatcher matcher) {
   ...
   */
  @RunsInCurrentThread
  @NotNull public Point pointAt(final @NotNull JTabbedPane tabbedPane, final int index) {
