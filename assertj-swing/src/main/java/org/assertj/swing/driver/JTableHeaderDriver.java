...
public class JTableHeaderDriver extends JComponentDriver {
   ...
   */
  @RunsInEDT
  public void clickColumn(JTableHeader tableHeader, @Nullable String columnName) {
   ...
   */
  @RunsInEDT
  public void clickColumn(JTableHeader tableHeader, @Nullable String columnName, MouseButton button,
                          int times) {
  ...
  @RunsInEDT
  public void clickColumn(JTableHeader tableHeader, Pattern columnNamePattern,
                          MouseButton button, int times) {
    clickColumn(tableHeader, new PatternTextMatcher(columnNamePattern), button, times);
  }

  @RunsInEDT
  private void clickColumn(JTableHeader tableHeader, TextMatcher matcher,
                           MouseButton button, int times) {
   ...
   */
  @RunsInEDT
  public JPopupMenu showPopupMenu(JTableHeader tableHeader, @Nullable String columnName) {
  ...
  @RunsInEDT
  private static Point pointAtName(final JTableHeader tableHeader,
