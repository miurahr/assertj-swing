...
public class JListDriver extends JComponentDriver {
  ...
  @RunsInEDT
  private void unselectItems(final JList<?> list, final TextMatcher matcher) {
    final List<Integer> indices = matchingItemIndices(list, matcher, cellReader());
    if (indices.isEmpty()) {
      throw failMatchingNotFound(list, matcher);
    }
   ...
   */
  @RunsInEDT
  public void selectItem(JList<?> list, @Nullable String value) {
   ...
   * @throws LocationUnavailableException if an element matching the given value cannot be found.
   */
  public void clickItem(JList<?> list, @Nullable String value, MouseButton button, int times) {
   ...
   *           the {@code JList}.
   */
  public void unselectItems(final JList<?> list, final int[] indices) {
    checkNotNullOrEmpty(indices);
    new MultipleSelectionTemplate(robot) {
      @Override
      int elementCount() {
   ...
   */
  @RunsInEDT
  public void unselectItem(JList<?> list, int index) {
   ...
   */
  @RunsInEDT
  public void requireSelection(final JList<?> list, @Nullable String value) {
   ...
   */
  @RunsInEDT
  public void drag(JList<?> list, @Nullable String value) {
   ...
   */
  @RunsInEDT
  public void drop(JList<?> list, @Nullable String value) {
  ...
  private void checkItemFound(JList<?> list, Pair<Integer, Point> scrollInfo,
                              TextMatcher matcher) {
   ...
   */
  @RunsInEDT
  public JPopupMenu showPopupMenu(JList<?> list, @Nullable String value) {
   ...
   */
  @RunsInEDT
  public Point pointAt(JList<?> list, @Nullable String value) {
   ...
   */
  @RunsInEDT
  public int indexOf(JList<?> list, @Nullable String value) {
