...
public class JTabbedPaneFixture extends
  ...
  @Override
  protected JTabbedPaneDriver createDriver(Robot robot) {
   ...
   */
  public JTabbedPaneFixture requireTitle(@Nullable String title, Index index) {
   ...
   */
  public JTabbedPaneFixture requireSelectedTab(Index expected) {
   ...
   */
  public JTabbedPaneFixture requireToolTipText(@Nullable String toolTipText, Index index) {
   ...
   *           pattern.
   */
  public JTabbedPaneFixture requireToolTipText(Pattern pattern, Index index) {
   ...
   */
  public JTabbedPaneFixture requireEnabled(Index index) {
   ...
   */
  public JTabbedPaneFixture requireDisabled(Index index) {
