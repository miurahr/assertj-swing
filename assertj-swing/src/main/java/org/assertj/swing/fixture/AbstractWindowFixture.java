 ...
 * @param <D> the type of {@link WindowDriver} that this fixture uses internally.
 *
 * @author Alex Ruiz
 */
public abstract class AbstractWindowFixture<S, C extends Window, D extends WindowDriver> extends
   ...
   */
  public AbstractWindowFixture(Class<S> selfType, Class<? extends C> type) {
   ...
   *           is found.
   */
  public AbstractWindowFixture(Class<S> selfType, Robot robot, Class<? extends C> type) {
   ...
   * @see org.assertj.swing.core.BasicRobot#robotWithCurrentAwtHierarchy()
   */
  public AbstractWindowFixture(Class<S> selfType, @Nullable String name, Class<? extends C> type) {
   ...
   *           is found.
   */
  public AbstractWindowFixture(Class<S> selfType, Robot robot, @Nullable String name,
   ...
   */
  public AbstractWindowFixture(Class<S> selfType, C target) {
   ...
   * @throws NullPointerException if the given target {@code Window} is {@code null}.
   */
  public AbstractWindowFixture(Class<S> selfType, Robot robot, C target) {
   ...
   */
  @Override
  public final S requireSize(Dimension size) {
   ...
   */
  @Override
  public final S resizeTo(Dimension size) {
   ...
   * @return this fixture.
   */
  public final S show(Dimension size) {
