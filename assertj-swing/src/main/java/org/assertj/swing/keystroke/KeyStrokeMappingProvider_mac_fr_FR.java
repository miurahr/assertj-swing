...
/**
 * Mapping between characters and {@code KeyStroke}s for Mac OS and locale {@code Locale.FRENCH}.
 * 
...
public class KeyStrokeMappingProvider_mac_fr_FR implements KeyStrokeMappingProvider {
  ...
  private static List<KeyStrokeMapping> createMappings() {
    ...
    mappings.add(mapping('1', VK_1, SHIFT_DOWN_MASK));
    mappings.add(mapping('�', VK_2, NO_MASK));
    mappings.add(mapping('2', VK_2, SHIFT_DOWN_MASK));
    mappings.add(mapping('"', VK_3, NO_MASK));
    mappings.add(mapping('3', VK_3, SHIFT_DOWN_MASK));
    mappings.add(mapping('\'', VK_4, NO_MASK));
    mappings.add(mapping('4', VK_4, SHIFT_DOWN_MASK));
    mappings.add(mapping('(', VK_5, NO_MASK));
    mappings.add(mapping('5', VK_5, SHIFT_DOWN_MASK));
    mappings.add(mapping('�', VK_6, NO_MASK));
    mappings.add(mapping('6', VK_6, SHIFT_DOWN_MASK));
    mappings.add(mapping('�', VK_7, NO_MASK));
    mappings.add(mapping('7', VK_7, SHIFT_DOWN_MASK));
    mappings.add(mapping('!', VK_8, NO_MASK));
    mappings.add(mapping('8', VK_8, SHIFT_DOWN_MASK));
    mappings.add(mapping('�', VK_9, NO_MASK));
    mappings.add(mapping('9', VK_9, SHIFT_DOWN_MASK));
    mappings.add(mapping('�', VK_0, NO_MASK));
    mappings.add(mapping('0', VK_0, SHIFT_DOWN_MASK));
    mappings.add(mapping(')', VK_MINUS, NO_MASK));
    mappings.add(mapping('�', VK_MINUS, SHIFT_DOWN_MASK));
    mappings.add(mapping('-', VK_EQUALS, NO_MASK));
    mappings.add(mapping('_', VK_EQUALS, SHIFT_DOWN_MASK));
    ...
    mappings.add(mapping('?', VK_M, SHIFT_DOWN_MASK));
    mappings.add(mapping('a', VK_Q, NO_MASK));
    mappings.add(mapping('A', VK_Q, SHIFT_DOWN_MASK));
    ...
    mappings.add(mapping('M', VK_SEMICOLON, SHIFT_DOWN_MASK));
    ...
    mappings.add(mapping('Q', VK_A, SHIFT_DOWN_MASK));
    ...
    mappings.add(mapping('W', VK_Z, SHIFT_DOWN_MASK));
    ...
    mappings.add(mapping('Z', VK_W, SHIFT_DOWN_MASK));
    return mappings;
  }
}
