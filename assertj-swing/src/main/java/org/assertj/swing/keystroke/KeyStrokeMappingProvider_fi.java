...
public class KeyStrokeMappingProvider_fi implements KeyStrokeMappingProvider {
  ...
  private static List<KeyStrokeMapping> createMappings() {
    ...
    mappings.add(mapping('£', VK_3, ALT_GRAPH_DOWN_MASK));
    mappings.add(mapping('4', VK_4, NO_MASK));
    mappings.add(mapping('¤', VK_4, SHIFT_DOWN_MASK));
    mappings.add(mapping('$', VK_4, ALT_GRAPH_DOWN_MASK));
    ...
    mappings.add(mapping('‚', VK_6, ALT_GRAPH_DOWN_MASK));
    ...
    mappings.add(mapping('?', VK_PLUS, SHIFT_DOWN_MASK));
    mappings.add(mapping('\\', VK_PLUS, ALT_GRAPH_DOWN_MASK));
    ...
    mappings.add(mapping('*', VK_QUOTE, SHIFT_DOWN_MASK));
    mappings.add(mapping('<', VK_LESS, NO_MASK));
    mappings.add(mapping('>', VK_LESS, SHIFT_DOWN_MASK));
    mappings.add(mapping('|', VK_LESS, ALT_GRAPH_DOWN_MASK));
    ...
    mappings.add(mapping('’', VK_COMMA, ALT_GRAPH_DOWN_MASK));
    ...
    mappings.add(mapping('–', VK_MINUS, ALT_GRAPH_DOWN_MASK));
